...
def get_soms(message):
    ...
    # msg = bot.send_message(message.chat.id,"Хотите продолжить?[да/нет]")
    # bot.register_next_step_handler(msg, continues)


# def continues(message):
#     if message.text.lower() == "да":
#         # msg = bot.send_message(message.chat.id, "ok")
#         # bot.register_next_step_handler(msg1, start_message)
